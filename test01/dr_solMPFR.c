    ...
    *****************************************************************************/
	...
	mpfr_set_str(v[3], "-0.040000000000000000000000000000000000000000000000000", 10, TIDES_RND);
	mpfr_set_str(v[4], "0.031000000000000000000000000000000000000000000000000", 10, TIDES_RND);
	mpfr_set_str(v[5], "0.00000000000000000000000000000000000000000000000000", 10, TIDES_RND);
	mpfr_set_str(v[6], "-0.010000000000000000000000000000000000000000000000000", 10, TIDES_RND);
	mpfr_set_str(v[7], "0.021000000000000000000000000000000000000000000000000", 10, TIDES_RND);
	mpfr_set_str(v[8], "0.010000000000000000000000000000000000000000000000000", 10, TIDES_RND);
